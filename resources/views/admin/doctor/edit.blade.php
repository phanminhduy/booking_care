                    ...
                    <div class="card-content">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control datepicker" name="birth_date" value="{{$doctor->birth_date}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <input type="password" class="form-control" name="password" value="{{$doctor->password}}">
                                    <span class="material-input"></span></div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <input type="text" class="form-control" name="nationality" value="{{$doctor->nationality}}">
                                    <span class="material-input"></span></div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <input type="text" class="form-control" name="price" value="{{$doctor->price}}">
                                    <span class="material-input"></span></div>
                            </div>
                        </div>
                    </div>
